...
class _OperitTerminalPageState extends State<OperitTerminalPage> {
  ...
  static const _sampleOutput = [
    ...
    _TermLine(text: '-rw-r--r--   1 user  staff  4096 May 30 18:45 data.json'),
    _TermLine(text: 'drwxr-xr-x   8 user  staff   256 May 28 11:00 src'),
    _TermLine(text: '-rwxr-xr-x   1 user  staff  1024 May 25 08:30 run.sh'),
    _TermLine(text: 'drwxr-xr-x   5 user  staff   160 May 22 16:10 logs'),
    _TermLine(text: '-rw-r--r--   1 user  staff   512 May 20 12:00 README.md'),
    _TermLine(text: ''),
